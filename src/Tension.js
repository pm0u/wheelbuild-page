...
class Tension extends Component {
  ...
  render() {
    ...
    <div className='row'>
      ...
      <div className='col s12 l4'>
        <p>Truing a wheel is a skill forever practiced and never mastered. It's a bit outside the scope of this tutorial to go deep into how to best true a wheel. There are two ways that a wheel can be out of true: Radially and Laterally.</p>
