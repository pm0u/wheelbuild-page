...
class Prep extends Component {
  ...
  render() {
    return (
      ...
      <p>The basic idea is to get all of these items within reach and make sure that they cannot be mixed together, knocked over, or spilled. I would argue these issues contribute to at least half of common frustrations with wheelbuilding. There is nothing worse than mixing all your spokes together so that it's impossible to tell which ones are for which side, or spilling your spoke nipples across the garage floor and losing 1 of them.</p>
